...
import { g as getActionQueryString, d as deserializeActionResult, e as ensure404Route, a as default404Instance, D as DEFAULT_404_ROUTE, m as manifest } from './chunks/_@astrojs-manifest_Ca-sZTob.mjs';
...
const _page2 = () => import('./pages/addphone.astro.mjs');
...
const _page6 = () => import('./pages/api/phoneedit/deletephoneentry.astro.mjs');
const _page7 = () => import('./pages/phonedetails.astro.mjs');
const _page8 = () => import('./pages/phones.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/addPhone.astro", _page2],
    ["src/pages/api/auth/register.ts", _page3],
    ["src/pages/api/auth/signin.ts", _page4],
    ["src/pages/api/auth/signout.ts", _page5],
    ["src/pages/api/phoneEdit/deletePhoneEntry.ts", _page6],
    ["src/pages/phoneDetails.astro", _page7],
    ["src/pages/phones.astro", _page8],
...
const _args = {
    "middlewareSecret": "a857f69b-3d0c-4d24-9f00-28935f0cfe73",
